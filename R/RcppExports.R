...
fagfit_cpp <- function(surv2, covar2, strata2, weights, offset, ibeta, sort1, sort2, method, maxiter, eps, H, Dstar, G, lambda, alpha, gamma, M, d, n_npvar, Dnrow, penalty, penalty_where, f, df_f) {
    .Call(`_fcoxph_fagfit_cpp`, surv2, covar2, strata2, weights, offset, ibeta, sort1, sort2, method, maxiter, eps, H, Dstar, G, lambda, alpha, gamma, M, d, n_npvar, Dnrow, penalty, penalty_where, f, df_f)
}

fcoxfit_cpp <- function(time, status, covar2, offset, weights, strata2, maxiter, eps, H, Dstar, G, method, ibeta, lambda, alpha, gamma, M, d, n_npvar, Dnrow, penalty, penalty_where, f, df_f) {
    .Call(`_fcoxph_fcoxfit_cpp`, time, status, covar2, offset, weights, strata2, maxiter, eps, H, Dstar, G, method, ibeta, lambda, alpha, gamma, M, d, n_npvar, Dnrow, penalty, penalty_where, f, df_f)
}
