...
fagfit_cpp <- function(surv2, covar2, strata2, weights, offset, ibeta, sort1, sort2, method, maxiter, eps, gamma, M, d, n_npvar, Dnrow, pen, penalty_where, f, df_f) {
    .Call(`_fcoxph_fagfit_cpp`, surv2, covar2, strata2, weights, offset, ibeta, sort1, sort2, method, maxiter, eps, gamma, M, d, n_npvar, Dnrow, pen, penalty_where, f, df_f)
}
