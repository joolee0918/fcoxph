...
fagfit_init <- function(surv2, covar2, strata2, weights, offset, ibeta, sort1, sort2, method, maxiter, eps, doscale) {
    .Call(`_fcoxph_fagfit_init`, surv2, covar2, strata2, weights, offset, ibeta, sort1, sort2, method, maxiter, eps, doscale)
}
